class Dimension {
  ...
  static const commonElevatedButtonWidthFactor = screenWidthFactor * 0.8;
  ...
  // const Dimension({required this.screenHeight, required this.screenWidth});
  // getAllSizes() {
  //   screenHeight;
  //   double heddingereaHeight = screenHeight / 6.73;
  //   double footerereaHeight = screenHeight / 32.15;

  //   return {'heddingereaHeight': heddingereaHeight};
  // }
